package com.hav.havlife.view.adapter.dashboard.intake
...
class DailyInTakeRowAdapter(context: Context) :
        RecyclerView.Adapter<DailyInTakeRowAdapter.EarningHolder>() {
...
//
        ...
        val v = LayoutInflater.from(p0.getContext())
            .inflate(R.layout.content_daily_intake_row, p0, false)
