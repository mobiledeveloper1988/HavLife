...
class UpcomingChallengeRowAdapter(context: Context) :
        RecyclerView.Adapter<UpcomingChallengeRowAdapter.EarningHolder>() {
...
//
        ...
        val v = LayoutInflater.from(p0.getContext())
            .inflate(R.layout.content_upcoming_challenge_row, p0, false)
