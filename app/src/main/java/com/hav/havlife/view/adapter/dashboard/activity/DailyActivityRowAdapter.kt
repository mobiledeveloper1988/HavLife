package com.hav.havlife.view.adapter.dashboard.activity
...
class DailyActivityRowAdapter(context: Context) :
        RecyclerView.Adapter<DailyActivityRowAdapter.EarningHolder>() {
...
//
        ...
        val v = LayoutInflater.from(p0.getContext())
            .inflate(R.layout.content_daily_activity_row, p0, false)
