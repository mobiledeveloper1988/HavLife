package com.hav.havlife.view.adapter.reward
...
class OfferRowAdapter(context: Context) :
        RecyclerView.Adapter<OfferRowAdapter.EarningHolder>() {
...
//
        ...
        val v = LayoutInflater.from(p0.getContext())
            .inflate(R.layout.content_fuel_start_row, p0, false)
